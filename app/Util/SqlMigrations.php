...
" . self::$down . "
    ...
    public function dirProject($dirProject)
    {
    ...
    public function write()
    {
        ...
        file_put_contents('../' . self::$dirProject .'/database/migrations/'.$filename, $schema);
    }
    ...
    public function convert($database)
    {
        ...
        if(!$tables)
        {
            dd("Tabela nao existe seu burro");
...
//- See more at: http://laravelsnippets.com/snippets/convert-existing-mysql-database-schema-into-a-laravel-migration-file#sthash.4YCt5lnG.dpuf
}
